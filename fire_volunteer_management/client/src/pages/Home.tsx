...
const galleryImages = [
  ...
  {
    src: "/images/gallery/earthquake-simulation.jpg",
    title: "地震模擬區",
    desc: "體驗地震並學習避難技巧",
  },
  {
    src: "/images/gallery/climate-globe.jpg",
    title: "即時氣候投影球",
    desc: "了解全球氣候變化",
  },
  {
    src: "/images/gallery/fire-rescue-experience.jpg",
    title: "消防救災體驗區",
    desc: "模擬消防救災情境",
  },
];
...
export default function Home() {
  ...
  // 獲取服務花絮（前6張）
  const { data: latestGallery } = trpc.gallery.getPublished.useQuery({
    limit: 6,
  });
  ...
  const galleryImagesFromDB = homeContent
    ? [
        ...
        {
          src:
            homeContent.heroImage2 ||
            "/images/gallery/earthquake-simulation.jpg",
          title: homeContent.heroImage2Title || "地震模擬區",
          desc: homeContent.heroImage2Desc || "體驗地震並學習避難技巧",
        },
        {
          src: homeContent.heroImage3 || "/images/gallery/climate-globe.jpg",
          title: homeContent.heroImage3Title || "即時氣候投影球",
          desc: homeContent.heroImage3Desc || "了解全球氣候變化",
        },
        {
          src:
            homeContent.heroImage4 ||
            "/images/gallery/fire-rescue-experience.jpg",
          title: homeContent.heroImage4Title || "消防救災體驗區",
          desc: homeContent.heroImage4Desc || "模擬消防救災情境",
        },
      ]
    : galleryImages;
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <Link href="/traffic">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white/20 shadow-lg px-8 py-6 text-lg"
                >
                  交通指引
                </Button>
              </Link>
